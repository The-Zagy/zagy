/**
 * ! FILE CONTAIN ONLY HARDCODE REPRESENTATION OF ALL CONFIG FILES
 */
import {TestChoise} from "./types.js"
export function packageJson(name:string,test:TestChoise):string{
    return `{
        "name": "${name}",
        "version": "1.0.0",
        "type":"module",
...
export function tsconfigJson(test:TestChoise):string{
    return `{
        "compilerOptions": {
            "target": "es2021",
            "module": "ES2022",
...
export function prettierJson():string{
    return `
    {
        "semi": true,
        "trailingComma": "none",
...
export function eslintJson():string{
    return `
    {
        "root": true,
        "plugins": [
...
export function jasmineJson():string{
    return `
    {
...
export function reporterJson():string{
...
export function jestJson():string{
    return `
{
    "verbose":true,
    "transform":{},
...
export function gitignoreJson():string{
    return `
# Logs
logs
*.log
